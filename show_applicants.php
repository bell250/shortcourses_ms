...
$sql = "SELECT applicants.applicant_id,applicants.ffirst_name, applicants.flast_name, applicants.mfirst_name, applicants.mlast_name, applicants.gender, applicants.date_of_birth, applicants.applicant_district, applicants.applicant_sector, applicants.guardian_first_name,applicants.guardian_last_name,applicants.guardian_phone, applicants.guardian_district,applicants.guardian_sector, applicants.level_of_education, applicants.title_of_certificate, applicants.id_number, users.user_first_name, users.user_last_name, users.user_email, users.user_phone, learning_options.name from applicants join users on applicants.user_id = users.user_id join learning_options on learning_options.id = applicants.learning_option_id ";
